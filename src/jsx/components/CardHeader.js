      ...
      <div className='d-flex justify-content-between'>
        ...
        <div>
          <DropdownButton variant='success' title={data?.title}>
            <Dropdown.Item onClick={() => setData({ title: 'Public', icon: 'bi bi-globe' })}>
              <div className={`d-flex cus-drop-down ${data?.title === 'Public' && 'active'}`}>
            ...
            <Dropdown.Item onClick={() => setData({ title: 'Private', icon: 'bi bi-lock' })}>
              <div className={`d-flex cus-drop-down ${data?.title === 'Private' && 'active'}`}>
